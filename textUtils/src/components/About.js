...
export default function About() {
  ...
  const handleChangeColor = () => {
    if(myStyle.color === 'white'){
      ...
      // document.getElementById('color').innerHTML = "Enable dark mode";  
    }
    else{
      setMyState({
        color: 'white',
      ...
      // document.getElementById('color').innerHTML = "Disable dark mode";
    }
  }

  return (
    <div className="conatainer" style={myStyle}>
        ...
        <div className="conatainer my-3 mx-4">
          <button id="color" className="btn btn-primary" onClick={handleChangeColor}>{btnText}</button>
        </div>
    </div>
  )
}
